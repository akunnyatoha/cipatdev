    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Daftar Pengembalian Barang</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form onsubmit="return confirm('Are you sure? ');" action="{{ route('dashboardpage.pengembalian.destroy', $i->id) }}" method="POST" class="d-inline">
                                                        <a href="{{route('dashboardpage.pengembalianbarang.edit', $i->id) }})}}" class="btn btn-warning">Edit</a>
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="{{route('dashboardpage.pengembalianbarang.create')}}" method="POST">
                                    @csrf
